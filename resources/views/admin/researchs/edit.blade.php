        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Horizontal Form -->
                    <form class="row g-3" method="post" action="{{ route('admin.researchs.update', $Research->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                        ...
                        <table class="table table-sm table-hover">
                            ...
                            @foreach($ResearchsData as $ResearchData)
                                <tr onclick="window.location.href = '{{ route('admin.researchsdata.edit', $ResearchData->id) }}';"
                                    style="cursor: pointer;">
                                    <th scope="row">{{ $ResearchData->id }}</th>
                                    <td>{{ $ResearchData->key }}</td>
                                    <td>{{ $ResearchData->value }}</td>
                                </tr>
                            @endforeach
                        ...
                        <table class="table table-sm table-hover">
                            ...
                            @foreach($ResearchsTrans as $ResearchTrans)
                                <tr onclick="window.location.href = '{{ route('admin.translate.edit', $ResearchTrans->id) }}';"
                                    style="cursor: pointer;">
                                    <th scope="row">{{ $ResearchTrans->id }}</th>
                                    <td>{{ $ResearchTrans->key }}</td>
                                    <td>{{ $ResearchTrans->value }}</td>
                                    <td>{{ $ResearchTrans->race }}</td>
                                    <td>{{ $ResearchTrans->lang }}</td>
                                </tr>
                            @endforeach
