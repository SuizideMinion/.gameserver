...
//        dd($Building->getData()->pluck('value', 'key'));
    ...
    public function getDataCsv()
    {
        ...
        if (!empty($lines)) {
            ...
            $keyListData = ['research_need', 'level', 'tech_level', 'tech_build_time', 'ress1', 'ress2', 'ress3', 'ress4', 'ress5', 'max_level', 'image'];
                ...
                foreach ($array as $a) {
                    if ($a['desc'] != '') {
                        ...
                        foreach ($keyListTrans as $Keys)
                        {
                            ...
                            echo 'create Translation Tech.name.' . $a['id'] .' -> ';
                        }
                    }
                    ...
                    foreach ($keyListData as $Keys)
                    {
                        if ($a[$Keys] != '') {
                            ...
                            echo 'create Data ' . $a['level'] . '.' . $Keys . '<br >';
                        }
                    }
                }
            }
